...
import { Camera, Mail, User, ShieldCheck, Key, LogOut } from 'lucide-react';
...
const AdminProfile = () => {
    ...
    return (
        <AdminLayout 
            ...
            subtitle="Security credentials and identity management."
        >
            <div className="max-w-4xl">
                <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden flex flex-col md:flex-row">
                    ...
                    <div className="flex-1 p-10">
                        <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-8">Authorization Context</h4>
                        <div className="space-y-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Registered Endpoint</label>
                                    <div className="flex items-center gap-3 p-4 bg-slate-50 rounded-xl border border-slate-100">
